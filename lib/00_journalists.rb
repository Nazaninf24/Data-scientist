...
puts " il y a #{journalists.length} journalistes dans mon array" #379


#Question2
puts "Combien d'handle contiennent un numéro ?" 
counter = 0
journalists.each do |count|
    if count =~ /\d/
        counter += 1
    end
 end
